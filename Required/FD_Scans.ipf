...
function ScanFastDAC(start, fin, channels, [numptsx, sweeprate, delay, ramprate, repeats, alternate, starts, fins, x_label, y_label, comments, nosave, use_awg, interlaced_channels, interlaced_setpoints,fake])
	...
	wave sc_awg_info
	if(use_AWG)
		// check if AWG wave was created
		if (waveexists(sc_awg_info)!=1)
			print "Warning: AWG waves have not been created. Use for example; fdawg_create(\"12.0,12.1\", \"0,1,2\", \"10\", overwrite = 1, print_on = 1)"
