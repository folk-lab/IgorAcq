...
// 1. install lakeshore on IGHN (makes sense, requires some work)
// 2. until 1 is done, don't waste too much time making this compatible with more than BFS
...
function SetSystem(frigde)
	...
	strswitch(frigde)
		...
		case "ighn":
			...
			break
		default:
			abort "Not a valid system. Blue Fors LD250 = bfs, Blue Fors LD400 = bfb, IGHN = ???" // FIX
	endswitch
end
